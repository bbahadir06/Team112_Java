...
public class C05_Equalls_EqualsIgnoreCase_conCat {
    ...
    public static void main(String[] args) {
        ...
        // sometimes if lowercase or uppercase situations are not important
        ...
        // when we try to compare String data type  with == symbols. It will check text and reference at the same time
