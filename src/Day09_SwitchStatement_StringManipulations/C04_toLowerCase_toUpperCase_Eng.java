...
public class C04_toLowerCase_toUpperCase_Eng {
    public static void main(String[] args) {
        ...
        str = str.toUpperCase(); // If we don't make the assignment we do not change the original value
        System.out.println(str); // JAVA İS LİFE
        System.out.println(str.toLowerCase()); // java is life
        str = str.toLowerCase(); // java is life


        System.out.println(str.toUpperCase(Locale.ENGLISH)); // JAVA IS LIFE  // with eng characters
