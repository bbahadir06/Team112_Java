...
public class C03_Maps {
    ...
    public static void main(String[] args) {
        ...
        /*
        When we are creating a map, to be able to reach the value easier and faster
        ...
        // {101=Ali-Cem-10-M, 102=Veli-Can-10-M, 103=Ali-Can-11-M, 104=Ayse-Cem-11-H, 105=Ayse-Han-10-H, 106=Veli-Han-10-H}
       ...
       // System.out.println(schoolMap.values("Ayse-Cem-11-H"));
