...
public class C01_Hospital {
    public static void main(String[] args) {
        ...
        // we are creating an object from ADoctor
        ...
        System.out.println(doctor2.nameOfHospital); // we changed "Star hospital" in ADoctor class via changing its name in 27. line
                                                    // so objects are also effective to change the variable in class
                                                    // result is Super Hospital
        ...
        // normally static variables belong to the class, so proper way of changing it is using the class
