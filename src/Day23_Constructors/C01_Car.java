...
public class C01_Car {
        ...
        // when we create a constructor in a class we should also create a copy of default constructor as in line 7
    public C01_Car() {
    }
    public C01_Car( int prc, String brnd){      // constructor with parameters as in line 13
        price = prc;
        brand = brnd;
    }
