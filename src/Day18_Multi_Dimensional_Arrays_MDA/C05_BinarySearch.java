...
public class C05_BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        // if the desired element is lower than the lowest element of the array, result will be -1
        // If we don't sort the array before using it, the result will give us no info about the value
